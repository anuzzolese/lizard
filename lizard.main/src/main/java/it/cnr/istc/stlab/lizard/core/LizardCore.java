...
//    	System.out.println("LizardCore.visitHierarchyTreeForBeans() visited "+ontClass);
            ...
            if(range != null){
            	if(range.isURIResource()){
                    if(range.isClass()){
                        ...
                        System.out.println("LizardCore.createBeanMethods() "+rangeClass.getEntityName()+" "+(rangeClass==null));
