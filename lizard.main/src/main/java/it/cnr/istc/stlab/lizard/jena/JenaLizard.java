package it.cnr.istc.stlab.lizard.jena;
...
import it.cnr.istc.stlab.lizard.jena.model.JenaOntologyCodeModel;

public class JenaLizard implements OntologyCodeGenerationRecipe {

	private URI ontologyURI;
	private JenaOntologyCodeModel ontologyModel;
	
	public JenaLizard(URI ontologyURI) {
		this.ontologyURI = ontologyURI;
		
		OntModel ontModel = ModelFactory.createOntologyModel(OntModelSpec.OWL_DL_MEM);
        ontModel.read(ontologyURI.toString());
        
        this.ontologyModel = new JenaOntologyCodeModel(ontModel);
    }
            			...
            			if(methods != null && !methods.isEmpty()){
	            			for(AbstractOntologyCodeMethod method : methods){
	            				if(method.getMethodType() == OntologyCodeMethodType.Get){
	            					...
	            					System.out.println("SOME VALUES " + method.getOwner().getEntityName());
            			...
            			if(methods != null && !methods.isEmpty()){
	            			for(AbstractOntologyCodeMethod method : methods){
	            				if(method.getMethodType() == OntologyCodeMethodType.Get){
	            					...
	            					System.out.println("MIN CARDINALITY");
            			...
            			if(methods != null && !methods.isEmpty()){
	            			for(AbstractOntologyCodeMethod method : methods){
	            				if(method.getMethodType() == OntologyCodeMethodType.Get){
	            					...
	            					System.out.println("MAX CARDINALITY");
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            OntologyCodeGenerationRecipe codegen = new JenaLizard(uri);
