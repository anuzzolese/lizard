...
public class MavenUtils {
    ...
    public static void buildProject(File pom){
        ...
        if(javaHome != null) request.setJavaHome(new File(javaHome));
        

        Invoker invoker = new DefaultInvoker();
        //System.out.println("MVN Home " + invoker.getMavenHome());
        if(invoker.getMavenHome() == null) invoker.setMavenHome(new File(System.getProperty("M2_HOME")));
    ...
    public static String detectMvnHome(){
        ...
        try {
            ...
            while((line=reader.readLine()) != null && !stop)
                if(line.startsWith(marker)) mvnHome = line.substring(marker.length()).trim();
    ...
    public static void main(String[] args) {
        System.out.println(MavenUtils.detectMvnHome());
    }
